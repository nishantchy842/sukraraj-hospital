   ...
   return (
      <section>
         ...
         <section className='px-[60px] md:px-[50px] sm:px-[20px]'>
            <div className='mx-auto mt-[41px] grid max-w-[1440px] grid-cols-[2fr_1fr] gap-x-[82px]  md:mb-[45px] md:grid-cols-1  sm:mb-[49px] sm:mt-[18px] sm:grid-cols-1 '>
               <section>
                  <article>
                     <div className='flex items-center justify-between border-b pb-[13px] sm:flex sm:items-start sm:justify-between sm:gap-x-[16px] sm:gap-y-[10px]'>
                        <div>
                     ...
                     <article className='prose max-w-full text-[18px] font-normal leading-[34px] text-grey50'>
                        {parse(
                           translate(
                              lang,
               ...
               <section>
                  <p className=' mb-[12px] text-[20px] font-semibold leading-[33px] text-grey30 md:mt-[30px] sm:mt-[30px]'>
                     {translate(
                        lang,
                        'Other Research and Academics',
                        'अन्य अनुसन्धान र शिक्षाविदहरू'
                     )}
                  </p>
                           ...
                           <div className=' flex size-full  flex-col items-center justify-center gap-y-[9px] border-r px-[15px]  text-[#808080]  sm:px-[10px]'>
                              <div className='w-[70px] shrink items-center  justify-center  text-[16px]  font-normal leading-[22px]'>
                                 ...
                                 <p className='mt-[9px] text-center'>
                                    {converAdToBs(notice.createdAt, 'YYYY')}
                                 </p>
                              </div>
                           </div>
