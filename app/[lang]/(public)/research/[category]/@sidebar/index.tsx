         ...
         <section className='max-h-[700px] w-full overflow-y-auto'>
            <article className='flex w-[308px] flex-col gap-y-[10px] md:w-full md:flex-row md:flex-wrap md:gap-x-[15px] sm:hidden'>
               {data?.result.map((item) => (
                  ...
                  >
                     <Link href={`${item.slug}`}>
                        <div className='flex w-full items-center justify-between px-[15px] py-[10px] md:w-fit md:gap-x-[20px] '>
                           <p
